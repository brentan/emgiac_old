...
CXXFLAGS = $(PREC) -I. -I.. -DHAVE_CONFIG_H -DIN_GIAC -DGIAC_GENERIC_CONSTANTS -DNO_STDEXCEPT -Os -s ALLOW_MEMORY_GROWTH=1 -s ASSERTIONS=1 -s GL_UNSAFE_OPTS=0 # -DEMCC_GLUT -s USE_SDL=2 # --llvm-opts 2 -v
CFLAGS =  $(PREC) -I. -I.. -v  # -pg
CPPFLAGS = $(CXXFLAGS)
LDJS2FLAGS = $(PREC)  -v -s EXPORTED_FUNCTIONS="['__ZN4giac7casevalEPKc']" -s ALLOW_MEMORY_GROWTH=1 -s LEGACY_GL_EMULATION=1 -s ASSERTIONS=1 -s GL_UNSAFE_OPTS=0 #-s USE_SDL=2 #--closure 1
LDJSFLAGS = $(PREC) -v -s EXPORTED_FUNCTIONS="['__ZN4giac7casevalEPKc']" -s ALLOW_MEMORY_GROWTH=1 -s LEGACY_GL_EMULATION=1 -s ASSERTIONS=1 -s GL_UNSAFE_OPTS=0 #-s USE_SDL=2 # -s USE_TYPED_ARRAYS=0 # -s TOTAL_MEMORY=24000000 
CXX=emcc
CC=emcc
