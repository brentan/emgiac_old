      ...
      {"lp_best_projection",0,    _LP_BEST_PROJECTION, _INT_MAPLECONVERSION,T_TYPE_ID},
      ...
      {"lp_gap_tolerance",0,    _LP_GAP_TOLERANCE, _INT_MAPLECONVERSION,T_TYPE_ID},
      {"lp_hybrid",0,    _LP_HYBRID, _INT_MAPLECONVERSION,T_TYPE_ID},
      ...
      {"lp_iteration_limit",0,    _LP_ITERATION_LIMIT, _INT_MAPLECONVERSION,T_TYPE_ID},
      {"lp_lastfractional",0,    _LP_LASTFRACTIONAL, _INT_MAPLECONVERSION,T_TYPE_ID},
      {"lp_max_cuts",0,    _LP_MAX_CUTS, _INT_MAPLECONVERSION,T_TYPE_ID},
      ...
      {"lp_time_limit",0,    _LP_TIME_LIMIT, _INT_MAPLECONVERSION,T_TYPE_ID},
